var LocationConflation = (() => {
    ...
    "node_modules/rbush/index.js"(exports, module) {
      ...
      rbush.prototype = {
        ...
        remove: function(item, equalsFn) {
          if (!item)
            return this;
          var node = this.data, bbox = this.toBBox(item), path = [], indexes = [], i, parent, index2, goingUp;
        ...
        _chooseSplitIndex: function(node, m, M) {
          var i, bbox1, bbox2, overlap, area, minOverlap, minArea, index2;
  ...
  var require_circle_to_polygon = __commonJS({
    "node_modules/circle-to-polygon/index.js"(exports, module) {
      ...
      module.exports = function circleToPolygon2(center, radius, numberOfSegments) {
    ...
    "node_modules/geojson-precision/index.js"(exports, module) {
      (function() {
        function parse(t, coordinatePrecision, extrasPrecision) {
          function point(p) {
            return p.map(function(e, index2) {
              if (index2 < 2) {
    ...
    "node_modules/@aitodotai/json-stringify-pretty-compact/index.js"(exports, module) {
      ...
      function stringify(obj, options) {
        ...
        return function _stringify(obj2, currentIndent, reserved) {
          ...
          var length3 = maxLength - currentIndent.length - reserved;
          var treeDepth = getTreeDepth(obj2);
          if (treeDepth <= maxNesting && string.length <= length3) {
          ...
          if (isObject(obj2)) {
            ...
            var items = [];
            var delimiters;
            var comma = function(array, index3) {
              return index3 === array.length - 1 ? 0 : 1;
            };
            if (Array.isArray(obj2)) {
              for (var index2 = 0; index2 < obj2.length; index2++) {
                items.push(_stringify(obj2[index2], nextIndent, comma(obj2, index2)) || "null");
              }
              delimiters = "[]";
            } else {
              Object.keys(obj2).forEach(function(key, index3, array) {
                var keyPart = JSON.stringify(key) + ": ";
                var value = _stringify(obj2[key], nextIndent, keyPart.length + comma(array, index3));
                if (value !== void 0) {
  ...
  function split(key, v, comparator) {
    ...
    if (v) {
      ...
      const cmp3 = comparator(v.key, key);
      if (cmp3 === 0) {
        left = v.left;
        right = v.right;
      } else if (cmp3 < 0) {
...
`);
  ...
  var Tree = class {
    ...
    add(key, data) {
      ...
      const cmp3 = comparator(key, t.key);
      if (cmp3 === 0)
        this._root = t;
      else {
        if (cmp3 < 0) {
    ...
    findStatic(key) {
      ...
      while (current) {
        const cmp3 = compare(key, current.key);
        if (cmp3 === 0)
          return current;
        else if (cmp3 < 0)
    ...
    next(d) {
      ...
      const comparator = this._comparator;
      while (root) {
        const cmp3 = comparator(d.key, root.key);
        if (cmp3 === 0)
          break;
        else if (cmp3 < 0) {
          successor = root;
  ...
  var location_conflation_default = class {
    ...
    resolveLocation(location) {
      ...
      if (valid.type === "point") {
        ...
        let feature2 = _cloneDeep(feature(id));
        let props = feature2.properties;
  ...
  function _clip(features2, which) {
    if (!Array.isArray(features2) || !features2.length)
      return null;
    const fn = { UNION: polygon_clipping_esm_default.union, DIFFERENCE: polygon_clipping_esm_default.difference }[which];
    const args = features2.map((feature2) => feature2.geometry.coordinates);
  ...
  return location_conflation_exports;
})();
/**
 * splaytree v3.0.1
 ...
 * @preserve
 */
//# sourceMappingURL=location-conflation.iife.js.map
